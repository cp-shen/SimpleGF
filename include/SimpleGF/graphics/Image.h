...
class Image {
public:
    Image(unsigned width, unsigned height, ImageFormat format, const unsigned char* pixels);
    virtual ~Image();
...
private:
    ...
    void _set(unsigned width, unsigned height, ImageFormat format, const unsigned char* pixels);
};
